      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <p className="text-sm mb-6" style={{ color: '#8b95aa' }}>
            ...
            <span className="font-medium" style={{ color: '#f0f4ff' }}>{itemName}</span>?
            This action cannot be undone.
          </p>
          <div className="flex gap-3">
            <button
              onClick={onCancel}
              className="flex-1 px-4 py-2 rounded-lg text-sm font-medium transition-colors hover:bg-white/5"
            ...
            <button
              onClick={onConfirm}
              className="flex-1 px-4 py-2 rounded-lg text-sm font-semibold transition-colors hover:opacity-90"
